...
export function FeedbackSuccessStep({
  ...
  return (
    <>
      <div className="obsolute w-14 h-1 left-[calc(50%-56px/2+0.5px)] top-3 bg-[#F4F4F5] opacity-25 rounded-md"></div>
      <header>
        <CloseButton />
      </header>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          ...
          className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-300"
        >
          Quero enviar outro
        </button>
      </div>
